jQuery.sap.require("UI5Mob.util.Formatter");
jQuery.sap.require("UI5Mob.util.Controller");

UI5Mob.util.Controller.extend("UI5Mob.view.Master", {
	...
	onRouteMatched : function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "UI5Mob.view.Detail",
			targetViewType : "XML"
		});
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("CompanyName", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
